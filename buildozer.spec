...
source.include_patterns = data/logo/*.png
...
requirements = python3==3.9.12,kivy==2.1.0,https://github.com/kivymd/KivyMD/archive/master.zip,pillow==8.3.1
